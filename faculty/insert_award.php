...
if($number > 0)  
 {  
      ...
      {  
           ...
           {  
                $sql = "INSERT INTO award(title,description,a_date,place) VALUES('$title[$i]','$description[$i]','$a_date[$i]','$place[$i]')";  
...
<nav class="navbar fixed-top navbar-expand-sm bg-primary navbar-dark " style="min-height:100px">
    ...
    <ul class="nav-item" style="padding-left:460px;">
		...
		<div class="container">
			<br />
			<br />
			<h2 align="center">AWARD INFORMATION</a></h2>
            ...
            <div class="table-responsive">  
                               <table class="table table-bordered" id="dynamic_field">  
                                    ...
                                    <tr><td><input type="text" name="a_date[]" placeholder="Enter date" class="form-control name_list" /></td>  
 ...
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           ...
           $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="a_date[]" placeholder="select date" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
