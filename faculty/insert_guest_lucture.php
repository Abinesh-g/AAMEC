...
if($number > 0)  
 {  
      ...
      {  
           ...
           {  
                $sql = "INSERT INTO guest_lucture(title,description,place,g_date) VALUES('$title[$i]','$description[$i]','$place[$i]','$g_date[$i]')";  
...
<nav class="navbar fixed-top navbar-expand-sm bg-primary navbar-dark " style="min-height:100px">
    ...
    <ul class="nav-item" style="padding-left:460px;">
		...
		<div class="container">
			<br />
			<br />
			<h2 align="center">GUESTLECTURE INFORMATION</a></h2>
...
<div class="table-responsive">  
                               <table class="table table-bordered" id="dynamic_field">  
                                    ...
                                    <tr><td><input type="text" name="place[]" placeholder="Enter place/institution name" class="form-control name_list" /></td> 
                                     <tr><td><input type="text" name="g_date[]" placeholder="Enter date" class="form-control name_list" /></td>  
 ...
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           ...
           $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="place[]" placeholder="Enter place/institution name" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');
             $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="g_date[]" placeholder="select date" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
