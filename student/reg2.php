...
<form class="form-signin text-center" style="padding-top:10px" method="post"><br><br><br><br><br><br><br>
<h1 class="h2 mb-3 font-weight-normal" style="padding-bottom:20px">REGISTER NUMBER</h1>
    ...
    event.charCode < 58)"  placeholder="Enter reg. no."><br>
